 ...
 */
class WatchdogTask : protected scheduling::StackTask<WatchdogStackSize>,
                     public scheduling::Task {
  public:
     ...
     */
    WatchdogTask(Watchlist watchlist)
        : scheduling::Task(m_task_stack), m_watchlist {watchlist} {}
