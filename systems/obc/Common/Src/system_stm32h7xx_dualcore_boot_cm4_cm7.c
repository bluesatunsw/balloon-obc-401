...
/* FPU settings ------------------------------------------------------------*/
    ...
    if (FLASH_LATENCY_DEFAULT > (READ_BIT((FLASH->ACR), FLASH_ACR_LATENCY))) {
         ...
         * FLASH_ACR register */
        MODIFY_REG(
            FLASH->ACR, FLASH_ACR_LATENCY, (uint32_t)(FLASH_LATENCY_DEFAULT)
        );
    }
    ...
    switch (RCC->CFGR & RCC_CFGR_SWS) {
        ...
        case RCC_CFGR_SWS_PLL1: /* PLL1 used as system clock  source */
            ...
            */
            ...
            if (pllm != 0U) {
                switch (pllsource) {
                    case RCC_PLLCKSELR_PLLSRC_HSI: /* HSI used as PLL clock
                                                      source */
                    ...
                    case RCC_PLLCKSELR_PLLSRC_CSI: /* CSI used as PLL clock
                                                      source */
                    ...
                    case RCC_PLLCKSELR_PLLSRC_HSE: /* HSE used as PLL clock
                                                      source */
